...
<section class="hwyd-section">
	...
	<div class="hwyd-panel">
		<img class="panel-img left" alt="Collage of Hack Club events" src="https://cdn.hackclub.com/019d6191-88a7-7daa-b4c0-fdcae2fffa38/attend_hc_events.png">
	...
	<div class="hwyd-panel">
		<div class="panel-text left">
			...
			<p class="sbody">
				Own our presence across YouTube, Instagram, TikTok, Twitter, and more. You'll post frequently and craft compelling stories alongside our community.
			</p>
		</div>
		<img class="panel-img right" alt="Collage of Hack Club events" src="https://cdn.hackclub.com/019d6191-88a7-7daa-b4c0-fdcae2fffa38/attend_hc_events.png">
	</div>
	<div class="hwyd-panel">
		<img class="panel-img left" alt="Michael Reeves that I stole off the internet" src="https://mediaproxy.tvtropes.org/width/1200/https://static.tvtropes.org/pmwiki/pub/images/mykull_6.png">
		<div class="panel-text right">
			<h3 class="stitle">Get mentored by Open Sauce creators</h3>
			<p class="sbody">
				Work directly with creators from Open Sauce — including Michael Reeves and William Osman — receiving hands-on mentorship while collaborating on content.
			</p>
		</div>
	</div>
</section>
